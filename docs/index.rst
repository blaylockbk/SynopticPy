...
`Synoptic's Weather API <https://docs.synopticdata.com/services/weather-data-api>`_ provides real-time and historical surface-based weather and environmental observations thousands of mesonet stations, and the `open-access data <https://synopticdata.com/pricing/open-access-pricing/>`_ is *free*. More data and enhances services may be purchased (from Synoptic, not me).
